			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"class" => "",
						"value" => array(
							__('Filled', 'ancora') => 'filled',
							__('Border', 'ancora') => 'border'
						),
						"type" => "dropdown"
					),
					array(
                    ...
                    array(
                        "param_name" => "bd_color",
                        "heading" => __("Button's border color", "ancora"),
                        "description" => __("Any color for button's border", "ancora"),
                        "class" => "",
                        "value" => "",
                        "type" => "colorpicker"
                    ),
                    array(
                        "param_name" => "bd_size",
                        "heading" => __("The thickness of the border(px)", "ancora"),
                        "description" => __("The thickness of the border.", "ancora"),
                        "admin_label" => true,
                        "class" => "",
                        "value" => "3",
                        "type" => "textfield"
...
//					),
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "is_hover",
                        "heading" => __("Hover", "ancora"),
                        "description" => __("Add hover", "ancora"),
                        "admin_label" => true,
                        "class" => "",
                        "value" => array(
                            __('No', 'ancora') => 'no',
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        ...
                        "description" => __("Select form style", "ancora"),
                        "class" => "",
                        "value" => array(
                            __('Normal', 'ancora') => 'normal',
                            __('Transparent', 'ancora') => 'transparent'
                        ),
                        "type" => "dropdown"
                    ),
					array(
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        ...
                        "description" => __("Border color for the icon", "ancora"),
                        "class" => "",
                        "value" => "",
                        "type" => "colorpicker"
                    ),
                    array(
                        "param_name" => "bd_width",
                        "heading" => __("Border size", "ancora"),
                        "description" => __("Border size", "ancora"),
                        "class" => "",
                        "value" => "",
                        "type" => "textfield"
                    ),
                    array(
                        ...
                        "heading" => __("Icon shadow", "ancora"),
                        "description" => __("Add shadow to icon", "ancora"),
                        "admin_label" => true,
                        "class" => "",
                        "value" => array(
                            __('No', 'ancora') => 'no',
...
//					),
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "grad",
                        "heading" => __("Use gradient", "ancora"),
                        "description" => __("Use gradient for the parallax background", "ancora"),
                        "admin_label" => true,
                        "class" => "",
                        "value" => array(
                            __('No', 'ancora') => 'no',
...
//					),
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "type",
                        "heading" => __("Quote type", "ancora"),
                        "description" => __("Select type of quote", "ancora"),
                        "admin_label" => true,
                        "class" => "",
                        "value" => array(
                            __('Type 1', 'ancora') => 'type_1',
                            __('Type 2', 'ancora') => 'type_2',
                        ),
                        "type" => "dropdown"
                    ),
					array(
...
//					),
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "icon",
                        "heading" => __("Social icon", "ancora"),
                        "description" => __("Select icon for current tab from Fontello icons set", "ancora"),
						"admin_label" => true,
						"class" => "",
                        "value" => $ANCORA_GLOBALS['sc_params']['icons'],
                        "type" => "dropdown"
