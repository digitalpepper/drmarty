			...
			$ANCORA_GLOBALS['shortcodes'] = array(
				...
				"trx_button" => array(
					...
					"params" => array(
						...
						"style" => array(
							...
							"dir" => "horizontal",
							"options" => array(
								'filled' => __('Filled', 'ancora'),
								'border' => __('Border', 'ancora')
							),
							"type" => "checklist"
						), 
						"size" => array(
                        ...
                        "bd_color" => array(
                            ...
                            "desc" => __("Any color for button's border", "ancora"),
                            "value" => "",
                            "type" => "color"
                        ),
                        "bd_size" => array(
                            "title" => __("The thickness of the border(px)", "ancora"),
                            "desc" => __("The thickness of the border.", "ancora"),
                            "value" => "",
                            "type" => "text"
                        ),
						"align" => array(
				...
				"trx_contact_form" => array(
					...
					"params" => array(
                        ...
                        "style" => array(
                            ...
                            "desc" => __("Select form style", "ancora"),
                            "value" => "normal",
                            "options" => array(
                                'normal' => __('Normal', 'ancora'),
				...
				"trx_icon" => array(
					...
					"params" => array(
                        ...
                        "bd_color" => array(
                            "title" => __("Icon's border color", "ancora"),
                            "desc" => __("Icon's border color", "ancora"),
                            "dependency" => array(
                                'icon' => array('not_empty'),
                                'background' => array('round','square')
                            ),
                        ...
                        "bd_width" => array(
                            "title" => __("Border size", "ancora"),
                            "desc" => __("Border size", "ancora"),
                            "dependency" => array(
                                'bd_color' => array('not_empty')
                            ),
                            "value" => "",
                            "type" => "spinner",
                        ),
                        "icon_shadow" => array(
                            "title" => __("Icon shadow", "ancora"),
                            "desc" => __("Add shadow to icon", "ancora"),
                            "value" => "no",
                            "type" => "switch",
                            "options" => $ANCORA_GLOBALS['sc_params']['yes_no']
                        ),
				...
				"trx_parallax" => array(
					...
					"params" => array(
                        ...
                        "grad" => array(
                            "title" => __("Use gradient", "ancora"),
                            "desc" => __("Use gradient for the parallax background", "ancora"),
                            "value" => "no",
                            "size" => "medium",
                            "options" => array(
                                'no' => __('No', 'ancora'),
				...
				"trx_quote" => array(
					...
					"params" => array(
                        ...
                        "photo" => array(
                            ...
                            "desc" => __("Select or upload photo of quote author or write URL of photo from other site", "ancora"),
                            "value" => "",
                            "type" => "media"
                        ),
                        "type" => array(
                            "title" => __("Quote type", "ancora"),
                            "desc" => __("Select type of quote", "ancora"),
                            "value" => "type_1",
                            "type" => "checklist",
                            "options" => array(
                                'type_1' => __('Type 1', 'ancora'),
                                'typ2_2' => __('Type 2', 'ancora'),
                            )
                        ),
						"_content_" => array(
				...
				"trx_socials" => array(
					...
					"children" => array(
						...
						"params" => array(
                            ...
                            "icon" => array(
                                "title" => __("Social network icon ",  'ancora'),
