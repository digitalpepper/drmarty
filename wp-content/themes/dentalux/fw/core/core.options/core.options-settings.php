...
if ( !function_exists( 'ancora_options_settings_theme_setup' ) ) {
	...
	function ancora_options_settings_theme_setup() {
        ...
        "page404_style" => array(
                   "title" => __('Page 404 style', 'ancora'),
                   "desc" => __('Select style for the 404 page', 'ancora'),
                   "override" => "category,courses_group,post,page",
                   "std" => "dark",
                   "options" => array(
                        'dark' => __('Dark', 'ancora'),
		...
		"show_contact_info" => array(
            ...
            "show_timetable_area" => array(
                "title" => __('Show timetable info', 'ancora'),
                "desc" => __("Show the timetable details for the owner of the site at the top right corner of the page", 'ancora'),
                "override" => "category,courses_group,post,page",
                "std" => "yes",
                "options" => $ANCORA_GLOBALS['options_params']['list_yes_no'],
                "type" => "switch"),
        ...
        "user_header_type" => array(
                    "title" => __("Header type", 'ancora'),
                    "desc" => __('Put header html-code and/or shortcodes here. You can use any html-tags and shortcodes', 'ancora'),
                    "override" => "category,courses_group,page,post",
                    "std" => "",
                    "options" => array(
                        'type_1' 	=> __('Type 1', 'ancora'),
                        'type_2'	=> __('Type 2', 'ancora'),
                    ),
                    "dir" => "horizontal",
                    "type" => "checklist"),
...
//        "show_copyright_in_footer" => array(
//                    "title" => __('Show Social icons in footer', 'ancora'),
//                    "desc" => __('Show area with  information and small social icons in footer', 'ancora'),
//                    "override" => "category,courses_group,post,page",
//                    "std" => "yes",
//                    "options" => $ANCORA_GLOBALS['options_params']['list_yes_no'],
//                    "type" => "switch"),
		...
		"footer_copyright" => array(
					...
					"override" => "category,courses_group,page,post",
					"std" => "Ancora &copy; 2015 All Rights Reserved ",
					"rows" => "10",
					"type" => "editor"),
		...
		"post_excerpt_maxlength" => array(
					"title" => __('Excerpt maxlength for streampage',  'ancora'),
		...
		"blog_pagination" => array(
					...
					"options" => array(
						...
						'viewmore' => __('"View more" button', 'ancora'),
						'infinite' => __('Infinite scroll', 'ancora')
					),
					"dir" => "vertical",
					"type" => "radio"),
        ...
        "before_contact_info" => array(
                    "title" => __('Title before contacts in header', 'ancora'),
                    "desc" => __('Title before string with contact info in the site header', 'ancora'),
                    "std" => "free call",
                    "before" => array('icon'=>'iconadmin-home'),
                    "type" => "text"),
		...
		"contact_info" => array(
            ...
            "timetable" => array(
                "title" => __('Timetable in header', 'ancora'),
                "desc" => __('String with timetable info in the site header', 'ancora'),
                "std" => "",
                "before" => array('icon'=>'iconadmin-calendar'),
                "type" => "text"),
