    ...
    function ancora_show_share_links($args) {
        ...
        foreach ($args['share'] as $soc) {
            ...
            $output .= '<div class="sc_socials_item">'
                ...
                . '>'
                . ($args['style']=='icons' ? '<span class="icon-' . esc_attr($sn) . ' sc_icon_shape_round"></span>' : ($args['style']=='images' ? '<img src="'.esc_url($icon).'" alt="'.esc_attr($sn).'" />' : '<span class="sc_socials_hover" style="background-image: url('.esc_url($icon).');"></span>'))
                . '</a>'
        ...
        if (count($list) > 0) {
            foreach ($list as $soc) {
                ...
                $output .= '<div class="sc_socials_item">'
                    ...
                    . '>'
                    . ($style=='icons' ? '<span class="sc_icon sc_icon_shape_round ' . esc_attr($sn) . '"></span>' : ($style=='images' ? '<img src="'.esc_url($icon).'" alt="" />' : '<span class="sc_socials_hover" style="background-image: url('.esc_url($icon).');"></span>'))
                    . '</a>'
                    . '</div>';
            }
        }
