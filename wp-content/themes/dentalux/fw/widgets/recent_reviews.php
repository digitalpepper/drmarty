 ...
 */
add_action( 'widgets_init', 'ancora_widget_recent_reviews_load' );

/**
 * Register our widget.
 */
function ancora_widget_recent_reviews_load() {
	register_widget('ancora_widget_recent_reviews');
}

/**
 * recent_reviews Widget class.
 */
class ancora_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => __('Recent reviews', 'ancora'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'ancora_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'ancora_widget_recent_reviews', __('Ancora - Recent reviews', 'ancora'), $widget_ops, $control_ops );
	...
	function widget($args, $instance) {
		...
		$post_rating = 'reviews_avg'.(ancora_get_theme_option('reviews_first')=='author' ? '' : '2');
