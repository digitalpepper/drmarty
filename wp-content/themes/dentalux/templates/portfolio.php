...
//			'h_crop' => 250,
		...
		ancora_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => __('Course excerpt', 'ancora'),
			'thumb_title'  => __('Small square image (crop)', 'ancora'),
			'w'		 => 250,
			'h'		 => 250
		));
		ancora_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => __('Course tile (with hovers, width=height) /2 columns/', 'ancora'),
			'thumb_title'  => __('Large square image (crop)', 'ancora'),
			'w'		 => 750,
			'h' 	 => 750
		));
		ancora_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => __('Course tile /3 columns/', 'ancora'),
			'thumb_title'  => __('Medium square image (crop)', 'ancora'),
			'w'		 => 400,
			'h'		 => 400
		));
		ancora_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => __('Course tile /4 columns/', 'ancora'),
			'thumb_title'  => __('Small square image (crop)', 'ancora'),
			'w'		 => 250,
			'h'		 => 250
		));
