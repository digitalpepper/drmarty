	...
	function ancora_template_masonry_output($post_options, $post_data) {
		...
		<div class="isotope_item isotope_item_<?php echo esc_attr($style); ?> isotope_item_<?php echo esc_attr($post_options['layout']); ?> isotope_column_<?php echo esc_attr($columns); ?>
			...
			<<?php echo ($tag); ?> class="post_item post_item_<?php echo esc_attr($style); ?> post_item_<?php echo esc_attr($post_options['layout']); ?>
                ...
                <?php if (!$post_data['post_protected'] && $post_options['info'] && $post_data['post_format'] != 'quote' && $post_data['post_format'] != 'chat' && $post_data['post_format'] != 'audio') {
				...
				<div class="post_content isotope_item_content">
					<div class="post_descr">
						...
						if ($post_data['post_protected']) {
							...
							if (empty($post_options['readmore'])) $post_options['readmore'] = __('More', 'ancora');
