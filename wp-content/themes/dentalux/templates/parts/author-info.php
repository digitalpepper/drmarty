...
if (ancora_get_custom_option("show_post_author") == 'yes') {
	...
	if ($post_data['post_type']=='post') {
		$post_author_title = __('About Author', 'ancora');
	...
	if (!empty($post_author_name)) {
		...
		<section class="post_author author vcard" itemprop="author" itemscope itemtype="http://schema.org/Person">
            ...
            <div class="post_author_content">
			    <h6 class="post_author_title"><?php echo esc_html($post_author_title);?><br><span class="post_author_name" itemprop="name"><a href="<?php echo esc_url($post_author_url); ?>" class="fn"><?php echo ($post_author_name); ?></a></span></h6>
