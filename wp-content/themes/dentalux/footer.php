...
global $ANCORA_GLOBALS;
			...
			?> 
				<div class="copyright_wrap">
					<div class="content_wrap">
                        <div class="footer_copyright"><?php echo force_balance_tags(ancora_get_theme_option('footer_copyright')); ?></div>
                        <?php echo do_shortcode('[trx_socials size="small"][/trx_socials]'); ?>
					</div>
				</div>
			<?php } ?>
...
<a href="#" class="scroll_to_top icon-up-open" title="<?php _e('Scroll to top', 'ancora'); ?>"></a>
