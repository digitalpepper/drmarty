...
>
	...
	<div class="body_wrap">
		...
		<div class="page_wrap">
            ...
            if (ancora_get_custom_option('user_header_type') == 'type_2') {
                $destination_top_panel = 'templates/parts/top-panel-2.php';
            } else {
                $destination_top_panel = 'templates/parts/top-panel-1.php';
            }
			if (in_array($top_panel_position, array('above', 'over'))) { require_once( ancora_get_file_dir($destination_top_panel) ); }
			require_once( ancora_get_file_dir('templates/parts/slider.php') );
			if ($top_panel_position == 'below') { require_once( ancora_get_file_dir($destination_top_panel) ); }
			...
			if ($top_panel_style=='light') {
				...
				if (empty($header_image2) && file_exists(ancora_get_file_dir('skins/'.($theme_skin).'/images/bg_over.png'))) {
			...
			if (ancora_get_custom_option('show_page_top') == 'yes') {
                ...
                $page404_style = ancora_get_custom_option('page404_style');
				?>
			...
			<div class="page_content_wrap<?php if (is_404()) echo ' page404_style_' . $page404_style;?>"<?php echo (ancora_get_custom_option('show_page_top') == 'no' ? ' ' . trim($header_style) : ''); ?>>
